...
@CucumberOptions(
					...
					//features= {".//Features/SubscriptionHome.feature"},
					//features= {".//Features/SubscriptionCartPage.feature"},
					//features= {".//Features/AddProductToCart.feature"},
		//features= {".//Features/ProductQuantityCart.feature"},
		features= {".//Features/PlaceOrderRegisterWhileCheckOut.feature"},
